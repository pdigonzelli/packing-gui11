...
ELSE IF SESSION:BATCH-MODE THEN DO:
  ...
  DO WHILE sending:
    ...
    PAUSE 1.  /* This may need to be removed when sending many emails, slows things down too much */
...
FUNCTION newstate RETURNS INTEGER
  ...
  /*PABLO MESSAGE newstate pstring VIEW-AS ALERT-BOX. */
...
FUNCTION Base64Encode RETURN CHARACTER (INPUT C_StringToEncode AS CHARACTER ):
  ...
  DO My_Counter = 1 TO LENGTH(C_StringToEncode) :
   ...
   /* MESSAGE STRING(MY_RAWDATA) SUBSTRING(C_StringToEncode,My_Counter,1)  VIEW-AS ALERT-BOX. */
