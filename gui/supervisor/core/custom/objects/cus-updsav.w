...
&Scoped-define SELF-NAME Panel-Frame
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Panel-Frame C-WIn
ON U10 OF FRAME Panel-Frame
DO:
  RUN AGREGAR IN THIS-PROCEDURE.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE U1O C-WIn 
PROCEDURE U1O :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
