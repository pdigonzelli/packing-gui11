...
DEFINE BUTTON Btn-Prev 
     ...
     LABEL "&Prev":L 
     SIZE 6 BY 1.43 TOOLTIP "Previous".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Panel-Frame
     Btn-First AT ROW 1 COL 1
     Btn-Prev AT ROW 1 COL 7
     Btn-Next AT ROW 1 COL 13
     Btn-Last AT ROW 1 COL 19
