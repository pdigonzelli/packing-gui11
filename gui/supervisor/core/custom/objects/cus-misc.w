...
DEFINE BUTTON Btn-Cons 
     ...
     LABEL "&Consultas":L 
     SIZE 6 BY 1.43 TOOLTIP "Consulta Relacionada".

DEFINE BUTTON Btn-Exit 
     IMAGE-UP FILE "custom/imagen/grandes/cueexit":U
     LABEL "&Salir":L 
     SIZE 6 BY 1.43 TOOLTIP "Salir".

DEFINE BUTTON Btn-Print 
     IMAGE-UP FILE "custom/imagen/grandes/print":U
     LABEL "&Imprimir":L 
     SIZE 6 BY 1.43 TOOLTIP "Imprimir".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Panel-Frame
     Btn-Cons AT ROW 1.24 COL 2
     Btn-Print AT ROW 1.24 COL 8
     Btn-Exit AT ROW 1.24 COL 14
