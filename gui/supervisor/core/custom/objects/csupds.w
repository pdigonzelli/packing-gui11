...
DEFINE BUTTON Btn-Add 
     ...
     LABEL "&Agregar" 
     SIZE 6 BY 1.43 TOOLTIP "Agregar".

DEFINE BUTTON Btn-Cancel 
     IMAGE-UP FILE "adeicon\cross":U
     LABEL "Ca&ncelar" 
     SIZE 6 BY 1.43 TOOLTIP "Cancelar".

DEFINE BUTTON Btn-Copy 
     IMAGE-UP FILE "custom/imagen/grandes/copy":U
     LABEL "&Copiar" 
     SIZE 6 BY 1.43 TOOLTIP "Copiar".

DEFINE BUTTON Btn-Delete 
     IMAGE-UP FILE "custom/imagen/grandes\trashcan":U
     IMAGE-INSENSITIVE FILE "custom/imagen/grandes\trashcan":U
     LABEL "&Borrar" 
     SIZE 6 BY 1.43 TOOLTIP "Borrar".

DEFINE BUTTON Btn-Reset 
     IMAGE-UP FILE "custom/imagen/grandes/undo":U
     LABEL "&Resetear" 
     SIZE 6 BY 1.43 TOOLTIP "Resetear".

DEFINE BUTTON Btn-Save 
     IMAGE-UP FILE "custom/imagen/grandes/save":U
     LABEL "&Grabar" 
     SIZE 6 BY 1.43 TOOLTIP "Grabar".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Panel-Frame
     Btn-Save AT ROW 1 COL 1
     Btn-Add AT ROW 1 COL 7
     Btn-Reset AT ROW 1 COL 13
     Btn-Copy AT ROW 1 COL 19
     Btn-Delete AT ROW 1 COL 25
     Btn-Cancel AT ROW 1 COL 31
...
ASSIGN 
       ...
       Btn-Add:HIDDEN IN FRAME Panel-Frame           = TRUE.

ASSIGN 
       Btn-Cancel:AUTO-RESIZE IN FRAME Panel-Frame      = TRUE
       Btn-Cancel:HIDDEN IN FRAME Panel-Frame           = TRUE.

ASSIGN 
       Btn-Copy:AUTO-RESIZE IN FRAME Panel-Frame      = TRUE
       Btn-Copy:HIDDEN IN FRAME Panel-Frame           = TRUE.

ASSIGN 
       Btn-Delete:AUTO-RESIZE IN FRAME Panel-Frame      = TRUE
       Btn-Delete:HIDDEN IN FRAME Panel-Frame           = TRUE.

ASSIGN 
       Btn-Reset:AUTO-RESIZE IN FRAME Panel-Frame      = TRUE
       Btn-Reset:HIDDEN IN FRAME Panel-Frame           = TRUE.

ASSIGN 
       Btn-Save:AUTO-RESIZE IN FRAME Panel-Frame      = TRUE
       Btn-Save:HIDDEN IN FRAME Panel-Frame           = TRUE.
