...
DEFINE BUTTON Btn-First 
     ...
     &ELSE SIZE 12 BY 1 &ENDIF TOOLTIP "First".
...
DEFINE BUTTON Btn-Last 
     ...
     LABEL "&Ultimo":L 
     &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN SIZE 12 BY 1
     &ELSE SIZE 12 BY 1 &ENDIF TOOLTIP "Last".
...
DEFINE BUTTON Btn-Next 
     ...
     LABEL "&Siguiente":L 
     &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN SIZE 12 BY 1
     &ELSE SIZE 12 BY 1 &ENDIF TOOLTIP "Next".
...
DEFINE BUTTON Btn-Prev 
     ...
     LABEL "&Previo":L 
     &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN SIZE 12 BY 1
     &ELSE SIZE 12 BY 1 &ENDIF TOOLTIP "Previous".
...
DEFINE FRAME Panel-Frame
     ...
     Btn-Prev
          ...
          &ELSE AT ROW 1 COL 13 &ENDIF
     Btn-Next
          &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN AT ROW 1 COL 25
          &ELSE AT ROW 1 COL 25 &ENDIF
     Btn-Last
          &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN AT ROW 1 COL 38
          &ELSE AT ROW 1 COL 38 &ENDIF
...
ON CHOOSE OF Btn-First IN FRAME Panel-Frame /* Primero */
DO:
...
ON CHOOSE OF Btn-Last IN FRAME Panel-Frame /* Ultimo */
DO:
...
ON CHOOSE OF Btn-Next IN FRAME Panel-Frame /* Siguiente */
DO:
...
ON CHOOSE OF Btn-Prev IN FRAME Panel-Frame /* Previo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE avanza P-Win 
PROCEDURE avanza :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
 apply 'choose' to btn-next in frame {&FRAME-NAME}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE primero P-Win 
PROCEDURE primero :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
 apply 'choose' to btn-first in frame {&FRAME-NAME}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE retrocede P-Win 
PROCEDURE retrocede :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
 apply 'choose' to btn-prev in frame {&FRAME-NAME}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ultimo P-Win 
PROCEDURE ultimo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
 apply 'choose' to btn-last in frame {&FRAME-NAME}.
