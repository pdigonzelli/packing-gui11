...
DEFINE RECTANGLE RECT-2
     ...
     &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN SIZE 144 BY 5
     &ELSE SIZE-PIXELS 720 BY 105 &ENDIF.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 2.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav ( 3.00 , 72.00 ) NO-ERROR.
       ...
       RUN set-size IN h_cus-navico ( 3.00 , 48.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 2.00 , 124.00 ) NO-ERROR.
