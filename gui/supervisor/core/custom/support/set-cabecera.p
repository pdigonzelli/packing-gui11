...
flag = true.
do i = 1 to cnt :
    if entry(i,p_code,chr(10)) matches "*EMPIEZA-TIPO-DETALLE*" then
        flag = false.
    if entry(i,p_code,chr(10)) matches "*TERMINA-TIPO-DETALLE*" then
    do:
        flag = true.
        next.
    end.
...
p_code = "/**********EMPIEZA-TIPO-DETALLE*********/" + chr(10) +
         "  run set-attribute-list ('tipo-detalle=cabecera'). " + chr(10) +
