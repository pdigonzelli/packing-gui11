...
define input-output parameter lista_campos as character.
...
DEFINE VARIABLE SELECT-1 AS CHARACTER 
     ...
     SIZE 31 BY 10.48 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     SELECT-1 AT ROW 1.95 COL 4 NO-LABEL
     BUTTON-1 AT ROW 12.67 COL 11
...
DO:
  do i=1 to num-entries(lista_campos):
    ...
    if cresult = "" then
        ...
        cresult= cresult + "," + select-1:entry(i).  
  end.
...
select-1:add-last(lista_campos).
