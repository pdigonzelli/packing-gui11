...
flag = true.
do i = 1 to cnt :
        if entry(i,p_code,chr(10)) matches "*EMPIEZA CON PARAMETROS*" then
            flag = false.
        if entry(i,p_code,chr(10)) matches "*TERMINA CON PARAMETROS*" then
        do:
            flag = true.
            next.
        end.
...
&ANALYZE-SUSPEND
    p_code = "/**********EMPIEZA CON PARAMETROS*********/" + chr(10) +
         "&SCOPED-DEFINE CON-PARAMETROS YES " + chr(10) +
