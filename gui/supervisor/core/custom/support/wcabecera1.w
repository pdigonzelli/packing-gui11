...
&Scoped-Define ENABLED-OBJECTS Cabecera detalle RECT-1 aceptar salir 
&Scoped-Define DISPLAYED-OBJECTS Cabecera detalle 
...
DEFINE FRAME F-Main
     ...
     aceptar AT ROW 4.81 COL 71
     salir AT ROW 4.81 COL 83
     RECT-1 AT ROW 4.57 COL 69
...
------------------------------------------------------------------------------*/
  DISPLAY Cabecera detalle 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE Cabecera detalle RECT-1 aceptar salir 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
    if cabecera:screen-value in frame {&FRAME-NAME} = "" or 
     detalle:screen-value in frame {&FRAME-NAME}  = "" then
  do:
