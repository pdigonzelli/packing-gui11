...
"ADM SmartBrowser Object Template with Wizard.

Use this template to create a new SmartBrowser object with the assistance of the SmartBrowser Wizard. When completed, this object can then be drawn onto any 'smart' container such as a SmartWindow, SmartDialog or SmartFrame."
*/
&ANALYZE-RESUME
...
&Scoped-define ADM-SUPPORTED-LINKS TableIO-Target,Consulta-Target,Navigation-Target,record-Source
...
/* SmartBrowser Wizard
Welcome to the SmartBrowser Wizard! During the next few steps, the wizard will lead you through creating a SmartBrowser object. You will define External Tables, if needed, define the query that you will use to retrieve data from your database(s) and select the database fields to display. Press Next to proceed.
adm/support/_wizntro.w,adm/support/_wizxtbl.w,adm/support/_wizqry.w,adm/support/_wizkey.w,adm/support/_wizfld.w,adm/support/_wizend.w 
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  /* SEND-RECORDS does nothing because there are no External
     Tables specified for this csmartbrowser, and there are no
