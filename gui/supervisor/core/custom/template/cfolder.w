...
&Scoped-Define ENABLED-OBJECTS Rect-Top Rect-Right Rect-Bottom Rect-Main ~
Rect-Left 
...
DEFINE FRAME Folder-Frm
     Rect-Top AT ROW 1.76 COL 1.2
     Rect-Right AT ROW 1.81 COL 34.2
     Rect-Bottom AT ROW 6 COL 1
     Rect-Main AT ROW 1.71 COL 1
     Rect-Left AT ROW 1.76 COL 1.2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 49.2 BY 6.71.
