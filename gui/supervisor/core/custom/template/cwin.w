...
&Scoped-define PROCEDURE-TYPE csmartwindow
...
&Scoped-Define ENABLED-OBJECTS RECT-1 aceptar salir 
...
/* Settings for THIS-PROCEDURE
   Type: csmartwindow Template
   Allow: Basic,Browse,DB-Fields,Smart,Window,Query
   Container Links: Record-Source,Record-Target,Navigation-Source,Navigation-Target,TableIO-Source,TableIO-Target,Page-Target,Consulta-Source
 */
...
run get-link-handle in adm-broker-hdl ( input this-procedure , input 'CONSULTA-TARGET' , output cresult).
h=widget-handle(cresult).
if valid-handle(h) then 
    run dispatch in h ( input 'initialize').
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE adm-busca-rowid W-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-apply-entry W-Win 
...
------------------------------------------------------------------------------*/
  ...
  /* SEND-RECORDS does nothing because there are no External
     Tables specified for this csmartwindow, and there are no
