...
define shared var r as rowid no-undo.


/**** CAMBIAR POR LA TABLA QUE CORRESPONDA *****/

&SCOPED-DEFINE TABLA proveedores
...
&Scoped-define PROCEDURE-TYPE cquerycons
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY {&SELF-NAME} FOR EACH {&TABLA} where rowid({&TABLA}) = r.
&Scoped-define TABLES-IN-QUERY-Query-Main {&TABLA}
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main {&TABLA}
...
/* Query rebuild information for QUERY Query-Main
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH {&TABLA} where rowid({&TABLA}) = r.
     _END_FREEFORM
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Design-Parent    is WINDOW q-tables @ ( 1.1 , 12.4 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "{&TABLA}"}
