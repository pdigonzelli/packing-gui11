...
/* admmsgs.i -- include file with translatable ADM messages (and others
  ...
  DEFINE VARIABLE cADMMessages AS CHARACTER NO-UNDO EXTENT 101
    INIT [
     "Debe seleccionar soli una fila para su borrado.",                                        /*  1 */
     "Los valores actuales deben ser grabados o cancelador antes de un alta.",                     /*  2 */
     "",                                                                                  /*  3  see below */
      /* message 4 is no longer used by adm as commitTransaction                          
         now has yes-no-cancel and are using message 3 */                                 
     "Los valores actuales deben ser grabados o cancelador antes de un commit.",                          /*  4 */
     "Query Prepare en initProps fallo.",                                                /*  5 */
     "Complete o cancele la actualizacion antes de cambiar de registro.",            /*  6 */
     "El registro actual cambio. Desea confirmar estoscambios?",               /*  7 */
     "Campo(s) &1 ha sido grabado por otro usuario. Su cambio fue rechazado.",     /*  8 */
     ...
     "debe completar la actualizacion actual.",                                   /* 12 */
     "Debe completar el alta actual.",                                      /* 13 */
     "Debe completar la copia actual.",                                     /* 14 */
     "Actualizacion cancelada.",                                                                 /* 15 */
     "",                                                                                  /* 16 - see below */
     "",                                                                                  /* 17 - see below */
     "El registro de la base de datos no existe o esta lockeado por otro usuario.",                 /* 18 */
     "",                                                                                  /* 19 - see below */
     "",                                                                                  /* 20 - see below */
     "Salir",  /* used in okToContinue()  */                                               /* 21 */
     "Continuar", /* used in okToContinue()  */                                            /* 22 */
     "Fallo al intentar borrar el registro.",                                                  /* 23 */
     "",                                                                                  /* 24 */
     "El broker JMS no esta disponible.",                                                    /* 25 */
