...
&IF DEFINED(EXCLUDE-createbuscador) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE createbuscador Procedure 
PROCEDURE createbuscador :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
MESSAGE "Buscador" VIEW-AS ALERT-BOX.
