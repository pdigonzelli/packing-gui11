...
/*------------------------------------------------------------------------
    ...
    Syntax      : {src/adm2/custom/actioncustom.i}

    Description :

    Created     : 05/25/1999
    Notes       : Referenced in {src/adm2/toolbar.i}
  ----------------------------------------------------------------------*/
...
/* Note: the actioncustom.p is no longer supported as we have merged the
         action class with he toolbar class. */
