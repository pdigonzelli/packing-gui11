...
DEFINE FRAME F-Main
     btnApply AT ROW 1.1 COL 64 WIDGET-ID 2
     btnBlank AT ROW 2.33 COL 64 WIDGET-ID 4
     btnReset AT ROW 3.62 COL 64 WIDGET-ID 6
...
ON CHOOSE OF btnApply IN FRAME F-Main /* Aplicar Filtros */
DO:
...
ON CHOOSE OF btnBlank IN FRAME F-Main /* Limpiar */
DO:
...
ON CHOOSE OF btnReset IN FRAME F-Main /* Resetear */
DO:
  RUN resetFields.
END.
