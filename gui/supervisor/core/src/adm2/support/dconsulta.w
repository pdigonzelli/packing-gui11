...
DEFINE INPUT    PARAMETER xColumn   AS CHARACTER NO-UNDO.
...
DEFINE FRAME gDialog
     Btn_OK AT ROW 1.24 COL 75
     Btn_Cancel AT ROW 2.48 COL 75
     Btn_Help AT ROW 4.48 COL 75
     SPACE(1.79) SKIP(6.66)
...
DO:
  DEFINE VAR xTargets       AS CHARACTER    NO-UNDO.
  DEFINE VAR i              AS INTEGER      NO-UNDO.
  DEFINE VAR qh             AS INTEGER      NO-UNDO.
  
  {get ContainerTarget xTargets}.
  DO i = 1 TO NUM-ENTRIES(xTargets):
    qh = WIDGET-HANDLE(ENTRY(i,xTargets)).
  END.
