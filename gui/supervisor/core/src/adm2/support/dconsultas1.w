...
DEFINE OUTPUT PARAMETER xTexto AS CHARACTER NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS Btn_OK EDITOR-1 Btn_Cancel Btn_Help 
...
------------------------------------------------------------------------------*/
  DISPLAY EDITOR-1 
      WITH FRAME gDialog.
  ENABLE Btn_OK EDITOR-1 Btn_Cancel Btn_Help 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
