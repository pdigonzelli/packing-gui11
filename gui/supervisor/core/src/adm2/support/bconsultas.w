...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.programName ~
rowObject.userName rowObject.descriptionName 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.programName FORMAT "X(15)":U
      rowObject.userName FORMAT "X(15)":U
      rowObject.descriptionName FORMAT "X(256)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "adm2/support/dconsultas.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.programName
     _FldNameList[2]   = _<SDO>.rowObject.userName
     _FldNameList[3]   = _<SDO>.rowObject.descriptionName
